        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded ${
              filter === 'all' ? 'bg-orange-600 text-white' : 'bg-slate-800 text-slate-300'
            }`}
          >
            All
          </button>
          <button
            ...
            className={`px-4 py-2 rounded ${
              filter === 'pending' ? 'bg-orange-600 text-white' : 'bg-slate-800 text-slate-300'
            }`}
          >
            Pending
          </button>
          <button
            ...
            className={`px-4 py-2 rounded ${
              filter === 'paid' ? 'bg-orange-600 text-white' : 'bg-slate-800 text-slate-300'
            }`}
          >
            Paid
          </button>
